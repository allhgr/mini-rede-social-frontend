...
const Perfil = () => { 
    ...
    const [perfilSelecionado, setPerfilSelecionado] = useState<typePerfil | null>();
    ...
    return (
        <div className="table-container">
            <div>
                ...
                <button className="btn-edit" onClick={() => setCadastrarPerfil(true)}>Adicionar</button>
                <table>
                    <thead>
                        <tr>
                            <th>ID</th>
                    ...
                    <tbody>
                        {perfil.map((perfil) => (
                            <tr key={perfil.id}>
                                ...
                                <td>
                                    <button className="btn-edit" onClick={() => handleEditar(perfil)}>Editar</button>
                                    <button className="btn-delete" onClick={() => handleExcluir(perfil.id!)}>Excluir</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
